                    	...
                    	<div class="row wow bounceInLeft" data-wow-delay="0.4s">
                            ...
                            <div class="col-sm-6 col-md-4">
                            	...
                            	<div id="footer_signup">
                                    <div id="email">
                                        <form id="subscribe" action="subcribe.php" method="POST">
                                            <input type="text" placeholder="Enter email address" name="email_next" data-validate="validate(required, email)"/>
