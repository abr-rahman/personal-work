<?php
  ...
  function unika_unika($table_name){
  ...
  function setup($table_name, $setup_name){
    $query = "SELECT set_value FROM $table_name WHERE set_name = '$setup_name'";
    return mysqli_fetch_assoc( mysqli_query(connect_to_db(),$query))['set_value'];
  }
